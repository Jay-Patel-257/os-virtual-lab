 ...
 * @author dell
 */
public class FifoInfo extends javax.swing.JFrame {
  ...
  //  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        lblNewLabel = new JLabel("FIRST IN FIRST OUT");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FifoInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
